...
// segones " que tanquin, es genera una excepció retorna: cadena entre posicio
...
// pre: --
// post: --
// retorna: vector<string> amb tots els components d'una línia CSV bàsica (només
// tractant separadors)
//          un component està format per tots els caràcters entre dos separador
